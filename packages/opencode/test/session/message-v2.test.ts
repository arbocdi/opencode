        ...
        parts: [
          {
            ...
            state: {
              ...
              title: "ls",
              metadata: { exit: 0, termination: "exit", truncated: false },
        ...
        content: [
          {
            ...
            output: {
              ...
              value: [
                ...
                "Result: succeeded",
                "Exit code: 0",
                "Original output truncated: no",
                "Recent output:\nthis should be cleared",
                "Historical output: tool-result://call-1",
                'Use tool_output with callID "call-1" and offset/limit or pattern to inspect details.',
              ].join("\n"),
            },
          },
        ],
